...
namespace PersonaServices.Services
{
    public static class PersonaServices
    {
        ...
        static PersonaServices()
        {
            ...
            {/*Medio punto de rating por cada procedimiento, riesgo, alergias*/
                new Persona{
                    ...
                    Quirurgico="sin dato",Alergias="3 Alerg",Rating = 3,Foto="https://lorempixel.com/400/400/people/1/"},
                new Persona {
                    ...
                    Quirurgico="2 Proc",Alergias="3 Alerg",Rating = 4,Foto="https://lorempixel.com/400/400/people/2/"},
                new Persona {
                    ...
                    Quirurgico="1 Proc",Alergias="3 Alerg",Rating = 5, Foto="https://lorempixel.com/400/400/people/3/"},
                new Persona {
                    ...
                    Infusiones="Ocasional",Respiratorio="sin dato",Neurologico="sin dato",
                    Quirurgico="1 Proc",Alergias="sin dato",Rating = 2, Foto="https://lorempixel.com/400/400/people/4/"},
                new Persona{
                    ...
                    Quirurgico="sin dato",Alergias="2 Proc",Rating = 1.5f, Foto="https://lorempixel.com/400/400/people/5/"},
                new Persona{
                    ...
                    Infusiones="Ocasional",Respiratorio="sin dato",Neurologico="sin dato",
                    Quirurgico="sin dato",Alergias="1 Alerg",Rating = 2, Foto="https://lorempixel.com/400/400/people/6/"},
                new Persona{
                    ...
                    Quirurgico="sin dato",Alergias="4 Alerg",Rating = 2.5f, Foto="https://lorempixel.com/400/400/people/7/"},
                new Persona{
                    ...
                    Infusiones="Niega",Respiratorio="1 Proc",Neurologico="2 Proc",
                    Quirurgico="sin dato",Alergias="1 Alerg",Rating = 2, Foto="https://lorempixel.com/400/400/people/8/"},
                new Persona { 
                    Id = 8,CodPaciente = 6512,Nombre = "Dimas", Apellido="Zabala",Email = "dimas@gmail.com",
                    ...
                    Infusiones="Niega",Respiratorio="1 Proc",Neurologico="sin dato",
                    Quirurgico="sin dato",Alergias="1 Alerg",Rating = 2.5f, Foto="https://lorempixel.com/400/400/people/9/"},
                new Persona { 
                    ...
                    Domicilio = "Huncal 962",Alcohol="Niega",Tabaco="Ocasional",Drogas="Niega",
                    Infusiones="Niega",Respiratorio="1 Proc",Neurologico="1 proc",
                    Quirurgico="sin dato",Alergias="sin dato",Rating = 1.5f, Foto="https://lorempixel.com/400/400/people/10/"}
            };
        }
